			...
			<div id="bgDiv" class="mc "  style="background:none;border:0px">
				...
				<!--<div class="form" style="position:absolute;left:80px;top:90px" >-->
					<div class="item fore1">
						...
						<!--<div class="item-ifo">-->
						<div class="item-ifo" style="height:40px;width:360px">
						   ...
						   <div style="width:30px;float:left">
						    ...
						    <input type="text" autocomplete="off" tabindex="1" value="" class="text" name="username" id="username"  placeholder="邮箱/用户名/已验证手机" 
						     style="background:0 0;border:none;float:left; outline:medium;
						     margin-left:20px;margin-top:5px;border-bottom:1px solid  rgba(255,255,255,.3);font-size:17" required="required">	
						</div>
					</div>
					<div class="item fore2">
						...
						<div style="width:30px;float:left">
						   <span class="input-group-addon" style="background:0 0;border:none"><i class="fa fa-key fa-fw" style="font-size:25px"></i></span>
							...
							margin-top:5px;border-bottom:1px solid  rgba(255,255,255,.3);font-size:17" placeholder="密码" required="required">
						</div>
					</div>
					<!--<div class="item login-btn2013">-->
					<div class="item login-btn2013" style="margin-left:15px;margin-top:18px">
						<button type="submit" class="btn btn-success btn-entry" style="width:318px;font-size:15px">登     录</button>
