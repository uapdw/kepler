define([ 'jquery', 'knockout', 'text!static/pages/ae/explore/explore.html', 'ParameterStore',
		'manager.jquery', 'AbstractWidget', 'bootstrap.min', 'css!static/css/dashboard.css'],
...
function($, ko, template) {
	...
	exploreViewModel.search = function() {
		if($("#txtKeyword").val() == ''){
			alert("请输入关键词！");	
		}else{
	...
	exploreViewModel.savetocsv = function() {
		if($("#txtKeyword").val() == ''){
			alert("没有可保存的查询结果！");	
		}else{
